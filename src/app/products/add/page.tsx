...
function AddProduct() {
  ...
  const {
    ...
    onSubmit: async (values: any, actions) => {
      ...
      // added by me
      const _brandsval = values.brands.map((brand: any) => brand.value).join(",");
      const _occasionval = values.occasion.map((occasion: any) => occasion.value).join(",");
  
      const productData: InsertProducts = {
